...
public object OnboardingScreenInstances {
    public val page1: ScreenInstanceId = ScreenInstanceId("ONBOARD_NATIVE#1")
    public val page2: ScreenInstanceId = ScreenInstanceId("ONBOARD_NATIVE#2")
    public val page3: ScreenInstanceId = ScreenInstanceId("ONBOARD_NATIVE#3")
    public val page4: ScreenInstanceId = ScreenInstanceId("ONBOARD_NATIVE#4")
